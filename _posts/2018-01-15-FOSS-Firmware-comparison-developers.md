...
| Wiki / forum / blog   | [github.com Wiki](https://github.com/arendst/Sonoff-Tasmota/wiki) <br> [Google Forum](https://groups.google.com/forum/#!forum/sonoffusers) | ~~[bitbucket.org](https://bitbucket.org/xoseperez/espurna/wiki/Home)~~ [github.com](https://github.com/xoseperez/espurna) | [letscontrolit Wiki](https://www.letscontrolit.com/wiki/index.php/ESPEasy/)<br> [letscontrolit forum](https://www.letscontrolit.com/forum/) |
| Issue tracker         | [github.com](https://github.com/arendst/Sonoff-Tasmota/issues) | ~~[bitbucket.org](https://bitbucket.org/xoseperez/espurna/issues?status=new&status=open)~~ [github.com](https://github.com/xoseperez/espurna/issues) | [github.org](https://github.com/letscontrolit/ESPEasy/issues) |
| Continuous integration | [TravisCI](https://travis-ci.org/arendst/Sonoff-Tasmota)      | [TravisCI](https://travis-ci.org/xoseperez/espurna)            | [TravisCI](https://travis-ci.org/letscontrolit/ESPEasy)       |
...
Xose hosts ESPurna on ~~[Bitbucket.org](https://bitbucket.org/xoseperez/espurna/)~~ [GitHub](https://github.com/xoseperez/espurna), and maintains couple of branches, 2 of them being important:
...
> Update: Xose moved the project to GitHub as of 2018-Jan-24, and is integrating it into TravisCI and other tools. Migration is still ongoing, but so far looks pretty good.
...
>Update: Wiki is now open and editable by anyone. If you have idea how to improve the documentation, please do it!
...
Codacy is reporting [A mark for code quality](https://www.codacy.com/app/lobradov/espurna?utm_source=lobradov@bitbucket.org&utm_medium=referral&utm_content=lobradov/espurna&utm_campaign=Badge_Grade) though number of overall code issues is in the range of 100s, and is mainly coming from inconsistent use of quotes in Javascript and from quick & dirty hacks Xose introduced into (unused) `build.sh` and `memalyzer.sh`. Ignoring `.js` and unused `.sh`, number of issues would drop down to the range of 10.
...
> Update: Seems Xose decided to put my assumption to the test and has moved the code over to GitHub. It will take some time until developers realize it's there and pick it up, but I'm more than happy to see this migrated.
